...
def main():
    ...
    # #traincar = factoriotools.Locomotive("locomotive")
    # traincar = factoriotools.CargoWagon("cargo-wagon")
    # traincar.set_absolute_position(5, 1)
    # traincar.set_orientation(0.75)
    # blueprint.add_entity(traincar)
