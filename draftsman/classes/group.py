...
# from draftsman.classes.blueprint import EntityList
...
#         # For simplicity's sake we prevent flipping or rotating for now
...
#         # type: (list[EntityLike]) -> None
#         if value is None:
#             self._entities = EntityList(self.blueprint)
#         elif isinstance(value, list):
#             self._entities = EntityList(self.blueprint, value)
#         else:
