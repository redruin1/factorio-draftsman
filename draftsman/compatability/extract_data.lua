...
local function extract_signals()
    ...
    signals_file:write("signal_IDs = OrderedDict([\n")
    ...
    signals_file:write("item_signals = OrderedDict([\n")
    ...
    signals_file:write("fluid_signals = OrderedDict([\n")
    ...
    signals_file:write("virtual_signals = OrderedDict([\n")
