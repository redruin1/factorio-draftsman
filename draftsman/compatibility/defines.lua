...
defines = {
    ...
    events = {
        on_ai_command_completed = 119,
        on_area_cloned = 124,
        on_biter_base_built = 57,
        on_brush_cloned = 125,
        on_build_base_arrived = 142,
        on_built_entity = 6,
        on_cancelled_deconstruction = 23,
        on_cancelled_upgrade = 121,
        on_character_corpse_expired = 94,
        on_chart_tag_added = 144,
        on_chart_tag_modified = 145,
        on_chart_tag_removed = 146,
        ...
        on_cutscene_cancelled = 168,
        on_cutscene_waypoint_reached = 35,
        on_difficulty_settings_changed = 62,
        on_entity_cloned = 123,
        on_entity_damaged = 102,
        on_entity_destroyed = 159,
        on_entity_died = 4,
        on_entity_logistic_slot_changed = 172,
        on_entity_renamed = 59,
        on_entity_settings_pasted = 33,
        on_entity_spawned = 136,
        on_equipment_inserted = 173,
        on_equipment_removed = 174,
        on_force_cease_fire_changed = 152,
        on_force_created = 29,
        on_force_friends_changed = 151,
        on_force_reset = 105,
        on_forces_merged = 107,
        on_forces_merging = 30,
        on_game_created_from_scenario = 126,
        on_gui_checked_state_changed = 3,
        on_gui_click = 1,
        on_gui_closed = 88,
        on_gui_confirmed = 147,
        on_gui_elem_changed = 69,
        on_gui_location_changed = 148,
        on_gui_opened = 87,
        on_gui_selected_tab_changed = 149,
        on_gui_selection_state_changed = 60,
        on_gui_switch_state_changed = 150,
        on_gui_text_changed = 2,
        on_gui_value_changed = 89,
        on_land_mine_armed = 106,
        on_lua_shortcut = 36,
        on_marked_for_deconstruction = 22,
        on_marked_for_upgrade = 120,
        on_market_item_purchased = 55,
        on_mod_item_opened = 86,
        on_permission_group_added = 167,
        on_permission_group_deleted = 166,
        on_permission_group_edited = 162,
        on_permission_string_imported = 164,
        on_picked_up_item = 5,
        on_player_alt_reverse_selected_area = 176,
        on_player_alt_selected_area = 52,
        on_player_ammo_inventory_changed = 38,
        on_player_armor_inventory_changed = 37,
        on_player_banned = 114,
        on_player_built_tile = 47,
        on_player_cancelled_crafting = 101,
        ...
        on_player_clicked_gps_tag = 160,
        on_player_configured_blueprint = 72,
        on_player_configured_spider_remote = 169,
        ...
        on_player_died = 43,
        on_player_display_resolution_changed = 98,
        on_player_display_scale_changed = 99,
        on_player_driving_changed_state = 28,
        on_player_dropped_item = 56,
        on_player_fast_transferred = 131,
        on_player_flushed_fluid = 161,
        on_player_gun_inventory_changed = 39,
        on_player_joined_game = 45,
        on_player_kicked = 115,
        ...
        on_rocket_launch_ordered = 117,
        on_rocket_launched = 10,
        on_runtime_mod_setting_changed = 61,
        on_script_inventory_resized = 158,
        on_script_path_request_finished = 118,
        on_script_trigger_effect = 154,
        on_sector_scanned = 7,
        on_selected_entity_changed = 54,
        on_spider_command_completed = 171,
        on_string_translated = 153,
        on_surface_cleared = 110,
        on_surface_created = 63,
        on_surface_deleted = 64,
        on_surface_imported = 127,
        on_surface_renamed = 128,
        on_technology_effects_reset = 104,
        on_tick = 0,
        on_train_changed_state = 25,
        on_train_created = 68,
        on_train_schedule_changed = 113,
        on_trigger_created_entity = 24,
        on_trigger_fired_artillery = 143,
        on_unit_added_to_group = 139,
        on_unit_group_created = 138,
        on_unit_group_finished_gathering = 141,
        on_unit_removed_from_group = 140,
