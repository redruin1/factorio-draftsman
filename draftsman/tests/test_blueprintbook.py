...
from draftsman.error import InvalidSignalError, IncorrectBlueprintTypeError
...
class BlueprintBookTesting(TestCase):
    ...
    def test_set_label_color(self):
        ...
        self.assertEqual(
            blueprint_book.label_color, {"r": 0.5, "g": 0.1, "b": 0.5, "a": 1.0}
        )
        self.assertEqual(
            blueprint_book.to_dict(),
            {
    ...
    def test_set_active_index(self):
        ...
        self.assertEqual(blueprint_book.active_index, 10)
