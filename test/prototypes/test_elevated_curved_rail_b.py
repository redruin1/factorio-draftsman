...
def test_json_schema():
    assert ElevatedCurvedRailB.json_schema(version=(1, 0)) is None
    assert ElevatedCurvedRailB.json_schema(version=(2, 0)) == {
        "$id": "urn:factorio:entity:elevated-curved-rail-b",
