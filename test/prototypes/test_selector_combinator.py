...
@pytest.mark.skipif(
    len(selector_combinators) == 0, reason="No selector combinators to test"
)
class TestSelectorCombinator:
    ...
    def test_set_mode(self):
        ...
        assert selector.quality_filter == QualityFilter(
