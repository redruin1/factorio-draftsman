# flip_belts.py
"""
An example of how to use `flip_belts` on a passed in blueprint or blueprint book.
`flip_belts` reverses the direction of belt entities in-place such that they 
...
corresponds to every belt entity flipped, including undergrounds and splitters.
...
The resultant blueprint book with all belts flipped is printed back to stdout.
...
from draftsman.extras import flip_belts
